 ...
 * generation time. Generic trampolines can mix progs with different arenas,
 * so they never convert, even when the traced function itself takes __arena
 * arguments. Return 0 when there is nothing to convert.
 */
