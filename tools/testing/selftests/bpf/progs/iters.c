...
__log_level(1)
__flag(BPF_F_TEST_STATE_FREQ)
__naked int vlog_reset_warn(void)
{
 	asm volatile (
		"r7 = -16;"
		"r1 = r10;"
...
__success
__log_level(2)
__msg("delaying loop state at (21)")
__msg("21: safe")
__msg("retiring (21)")
__msg("delaying loop state at (8)")
__msg("8: safe")
__msg("retiring (8)")
__naked int loop_states_order1(void)
{
 	asm volatile (
		"r1 = r10;"
		"r1 += -8;"
...
__success
__log_level(2)
__msg("delaying loop state at (22)")
__msg("22: safe")
__msg("rescheduling (22)")
__msg("delaying loop state at (22)")
__msg("22: safe")
__msg("retiring (22)")
__msg("delaying loop state at (9)")
__msg("9: safe")
__msg("retiring (9)")
__naked int loop_states_order2(void)
{
 	asm volatile (
		"r7 = -16;"
		"r1 = r10;"
	...
	"j_loop_%=:"
		...
		"r1 += -8;"
		"call %[bpf_iter_num_next];"
		"if r0 == 0 goto j_loop_end_%=;"	/* 22 */
		"call %[bpf_get_prandom_u32];"
		"if r0 == 42 goto j_else_%=;"
		"r7 = -32;"
		"goto j_loop_%=;"
	"j_else_%=:"
		"r0 = r10;"
...
__log_level(2)
__msg("from 9 to 10")
__msg("delaying loop state at (10)")
__msg("10: safe")
__msg("from 31 to 32")
__msg("delaying loop state at (32)")
__msg("delaying loop state at (10)")
__msg("moving delayed states from loop entries at: 32")
__msg("10: safe")
__msg("from 18 to 19")
__msg("delaying loop state at (19)")
__msg("delaying loop state at (10)")
__msg("moving delayed states from loop entries at: 19")
__msg("10: safe")
__msg("from 31 to 32")
__msg("delaying loop state at (32)")
__msg("delaying loop state at (10)")
...
__msg("retiring (10)")
__msg("retiring (10)")
__naked int loop_states_order3(void)
{
 	asm volatile (
		"r1 = 0;"
		"*(u64 *)(r10 - 8) = r1;"
