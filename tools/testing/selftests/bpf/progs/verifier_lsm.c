...
__success
__naked int errno_zero_retval_test2(void)
{
	asm volatile (
	"r0 = -4095;"
	"exit;"
...
__naked int errno_zero_retval_test4(void)
{
	asm volatile (
	"r0 = -4096;"
	"exit;"
...
__failure __msg("R0 has smin=4096 smax=4096 should have been in [-4095, 0]")
__naked int errno_zero_retval_test5(void)
{
	asm volatile (
	"r0 = 4096;"
	"exit;"
...
__naked int errno_zero_retval_test6(void)
{
	asm volatile (
	"r0 = 1;"
	"exit;"
...
__success
__naked int bool_retval_test1(void)
{
	asm volatile (
	"r0 = 1;"
	"exit;"
...
__success
__success
__naked int bool_retval_test2(void)
{
	asm volatile (
	"r0 = 0;"
	"exit;"
...
__naked int bool_retval_test3(void)
{
	asm volatile (
	"r0 = -1;"
	"exit;"
...
__naked int bool_retval_test4(void)
{
	asm volatile (
	"r0 = 2;"
	"exit;"
...
__naked int void_retval_test1(void)
{
	asm volatile (
	"r0 = -4096;"
	"exit;"
...
__naked int void_retval_test2(void)
{
	asm volatile (
	"r0 = 4096;"
	"exit;"
