...
void __arena* bpf_arena_alloc_pages(void *map, __u32 page_cnt, int node_id, __u64 flags) __ksym;
...
static inline void __arena* bpf_arena_alloc_pages(void *map, __u32 page_cnt, int node_id, __u64 flags)
{
	return NULL;
}
